...
export const AUTOMATION_CODE_SYSTEM = `You are an expert Principal Test Automation Architect specializing in Cypress and Playwright.
...
export const buildAutomationCodePrompt = (requirement, framework = "playwright", language = "javascript") =>
  `Generate ${framework} automation test suite in ${language} for this feature/requirement:\n"""\n${requirement}\n"""`;

export const DATABASE_QUERY_SYSTEM = `You are a senior Database Architect and QA Engineer.
...
export const API_TEST_SYSTEM = `You are a senior API Testing Specialist.
...
export const CHAT_AI_SYSTEM = `You are an Enterprise AI QA Copilot assisting SQA Lead, Automation Engineers, and Developers.
...
export const BUG_WRITER_SYSTEM = `You are an Enterprise QA Lead.
